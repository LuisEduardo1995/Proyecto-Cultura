	...
	<!-- NavBar -->
		...
		<div class="container-fluid">
			<div class="page-header">
			 <h1 class="text-titles"><i class="zmdi zmdi-book zmdi-hc-fw"></i> MODIFICAR GRUPO<small> </small></h1>
			</div>
			<p class="lead">     </p>
		</div>
		<div class="container-fluid">
							...
							<div class="container-fluid">
								<div class="row">
									...
									<div class="col-xs-12 col-md-10 col-md-offset-1">
									    ...
									    <form class="expose"  enctype="multipart/form-data" action="control/modificarGrupo.php" method="post" name="formulario" onsubmit="return validarusuario(this)">
											...
											<div class="form-group label-floating">
											  ...
											  <select class="form-control"  type="text" name="expresionCurso2" id="expresionCurso">
												  ...
												  switch($expresion ){
													  ...
													  echo "<option value='HISTORIA' > Historia</option>
															<option value='DIRECCION'>Direcci&oacute;n</option>
															<option value='APRECIACION CINEMATOGRAFICA' selected>Apreciaci&oacute;n Cinematograf&iacute;ca</option>";
													  break;
												  }
										          ?>
											...
											?>
											<div class="form-group label-floating">
											  <label class="control-label"> Expresi&oacute;n Pl&aacute;stica </label>
