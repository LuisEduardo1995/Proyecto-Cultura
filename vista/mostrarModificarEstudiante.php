...
$cedula = $_GET["cedula"];
$sql="SELECT * FROM integrante WHERE cedula = $cedula" ;
	...
	<!-- NavBar -->
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-account zmdi-hc-fw"></i> INTEGRANTE <small></small></h1>
			</div>
			<p class="lead">     </p>
		</div>
		<div class="container-fluid">
							...
							<div class="container-fluid">
								<div class="row">
									...
									<div class="col-xs-12 col-md-10 col-md-offset-1">
									    ...
									    <form class="expose"  enctype="multipart/form-data" action="control/modificarEstudiante.php" method="post" name="formulario" onsubmit="return validarusuario(this)">
