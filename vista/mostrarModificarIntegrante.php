...
<!-- ======================================================================================================================== -->
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-account zmdi-hc-fw"></i> INTEGRANTE DE LOS GRUPOS <small></small></h1>
			</div>
			<p class="lead">     </p>
		</div>
		<div class="container-fluid">
							...
							<div class="container-fluid">
								<div class="row">
									...
									<div class="col-xs-12 col-md-10 col-md-offset-1">
									    ...
									    <form class="expose"  enctype="multipart/form-data" action="control/modificarIntegrante.php" method="post" name="formulario" onsubmit="return validarusuario(this)">
