	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"> AGRUPACIONES POR NUCLEOS  <small></small></h1>
			</div>
		</div>
			...
			<article class="full-box tile">
				...
				<div class="cd-timeline-block">
                    <div class="cd-timeline-img">
                       <a href="agrupacio.php?nucleo=MUSICA"> <img src="./assets/img/musica.jpg " alt="user-picture">
                    </div>
			</article>
			<article class="full-box tile">
				<div class="full-box tile-title text-center text-titles text-uppercase">
				...
				<div class="cd-timeline-block">
                    <div class="cd-timeline-img">
                      <a href="agrupacio.php?nucleo=CINEMATOGRAFIA">  <img src="./assets/img/cine.jpg" alt="user-picture">
                    </div>
			</article>
			<article class="full-box tile">
				<div class="full-box tile-title text-center text-titles text-uppercase">
				...
				<div class="cd-timeline-block">
                    <div class="cd-timeline-img">
                       <a href="agrupacio.php?nucleo=ARTES ESCENICAS"> <img src="./assets/img/escenicas.jpg" alt="user-picture">
                    </div>
				</div>
			</article>
			<article class="full-box tile">
				...
				<div class="cd-timeline-block">
                    <div class="cd-timeline-img">
                       <a href="agrupacio.php?nucleo=PLASTICA"> <img src="./assets/img/plastica.jpg" alt="user-picture">
                    </div>
				</div>
			</article>
			<article class="full-box tile">
				...
				<div class="cd-timeline-block">
                    <div class="cd-timeline-img">
                      <a href="agrupacio.php?nucleo=ARTESANIA">  <img src="./assets/img/artesania.jpg" alt="user-picture">
                    </div>
				</div>
			</article>
		</div>
